...
public class FuncionarioTesting {
        ...
        public void fillCreateFuncionarioForm(String name, String lastName, String cedula, String phone, String email,
        ...
        public void DeactivateaFuncionaryAsFuncionaryTest() {
                ...
                assertTrue(FuncionariosPage.isFuncionario2CardVisible(),
                                "Debería ser visible el funcionario 2 antes de eliminarlo");
                FuncionariosPage.clickFuncionario2();
                FuncionariosPage.clickEliminarFuncionario2Confirm();
                FuncionariosPage.aceptarAlerta();
                assertTrue(FuncionariosPage.isNOTFuncionario2CardVisible(),
                                "NO debería verse el funcionario 2 en la lista de usuarios activos");
                // Si se quiere verificar que el funcionario 2 aparece en la lista de inactivos,
                // se puede descomentar lo siguiente:
                /*
                 * FuncionariosPage.clickInactiveButton();
                 * assertTrue(FuncionariosPage.isFuncionario2CardInactiveVisible(),
                 * "Debería ser visible el funcionario 2 en la lista de usuarios inactivos");
                 */
        }
        ...
        public void createFuncionaryWithUsedCredentials() {
                ...
                fillCreateFuncionarioForm("Test", "Test", "12345678", "12345678", "carlos.rodriguez@saltoinnova.gub.uy",
                                "password", "Consulta");
        ...
        public void CrearFuncionarioEmailYaUtilizado() {
                ...
                HomePage.clickVerGestionarUsuario();
                FuncionariosPage.clickCreateFuncionarioButton();
                fillCreateFuncionarioForm("Maxie", "Roob", "34334178", "59443678", "erich@example.com", "password",
                                "Consulta");
                FuncionariosPage.clickCreateFuncionarioSubmit();
        }
        ...
        public void CrearFuncionarioCedulaYaUtilizado() {
                ...
                HomePage.clickVerGestionarUsuario();
                FuncionariosPage.clickCreateFuncionarioButton();
                fillCreateFuncionarioForm("Lucas", "Chiappini", "12345678", "59423878", "chiappinilucas@example.com",
                                "password", "Consulta");
                FuncionariosPage.clickCreateFuncionarioSubmit();
        ...
        public void CrearFuncionario() {
                ...
                HomePage.clickVerGestionarUsuario();
                FuncionariosPage.clickCreateFuncionarioButton();
                fillCreateFuncionarioForm("Lucas", "Martinez", "55764534", "51423838", "Martinezlucas@example.com",
                                "password", "Asesor Interno");
                FuncionariosPage.clickCreateFuncionarioSubmit();
